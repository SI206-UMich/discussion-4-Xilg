class Rectangle():
    ...
    # YOUR CODE HERE
    def area(self):
        return self.width * self.height if self.verify_input() == True else "Invalid input"
    ...
    def perimeter(self):
        return self.width * 2 + self.height * 2 if self.verify_input() == True else "Invalid input"
